            ...
            <div className="min-h-screen bg-gray-100 flex justify-center py-8">
                <div className="w-3/4">
                    {dataUser ? (
                        <div>
                            <h1 className="text-2xl font-medium text-center mt-8 mb-5">
                                Examenes dentales de {dataUser.Login.name} {dataUser.Login.lastName}
                            </h1>
                    ...
                    <Link href={{
                        ...
                        className="group fixed bottom-32 right-9 bg-blue-500 text-white py-2 px-3 rounded-full shadow-lg hover:bg-blue-600 transform transition-transform duration-200 scale-100 hover:scale-105"
                    >
                        <FontAwesomeIcon
                            icon={faFileMedical}
                            size="2x"
